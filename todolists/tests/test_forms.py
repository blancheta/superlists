...
class NewListFormTest(TestCase):
	...
	@patch('todolists.forms.List.create_new')
	def test_save_creates_new_from_post_data_if_user_not_authenticated(
	...
	@patch('todolists.forms.List.create_new')
	def test_save_creates_new_from_post_data_if_user_authenticated(
		self, mock_List_create_new
	):
